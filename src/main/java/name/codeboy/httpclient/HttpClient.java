...
public class HttpClient implements ChannalCloseListener {
    ...
    public HttpClient(GlobalConfig globalConfig) {
        this.remoteHost = globalConfig.host;
        this.remotePort = globalConfig.port;
        this.maxUseLocalPortNum = globalConfig.localPortNum;
        sendHandler = new HttpClientHandler(msgQueue, this, RateLimiter.create(globalConfig.getQpsLimit()));
        group = new NioEventLoopGroup(globalConfig.threadNum);
